...
public class Loc {
    ...
    public String genQrCode(int idCob, String access_token) {
        ...
        try {
            ...
            URI uri = new URI("https://api-pix.gerencianet.com.br/v2/loc/" + idCob + "/qrcode");
            URL url = uri.toURL();
    ...
    public String saveImage(String image) {
        ...
        try {
            ...
            byte[] imageBytes = java.util.Base64.getDecoder().decode(base64Image); // Substituição de javax.xml.bind.DatatypeConverter
