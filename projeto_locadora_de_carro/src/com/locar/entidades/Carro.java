...
public class Carro {
	...
	public Carro(String marca, String modelo, int ano, String cor, String placa, String numMotor, String chassi,
			String combustivel, String transmissao, String categoria, String conservacao, String direcao,
	...
	public Carro(String marca, String modelo, int ano, String cor, String numMotor, String chassi, String combustivel,
			String transmissao, String categoria, String conservacao, String direcao, String kmRodados, int numLugares,
			int numPortas) {
		this.marca = marca;
		this.modelo = modelo;
		this.ano = ano;
	...
	public Carro(long id, String marca, String modelo, int ano, String cor, String placa, String numMotor,
			String chassi) {
		this.id = id;
		this.marca = marca;
		this.modelo = modelo;
