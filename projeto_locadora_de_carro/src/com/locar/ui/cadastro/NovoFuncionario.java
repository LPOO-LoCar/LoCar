...
public class NovoFuncionario extends JFrame {
	...
	public NovoFuncionario() {
		...
		JLabel funTitulo_Label = new JLabel("Cadastro de Funcionários");
		funTitulo_Label.setForeground(new Color(0, 0, 0));
		funTitulo_Label.setFont(new Font("Tahoma", Font.PLAIN, 35));
		funTitulo_Label.setBounds(132, 9, 397, 35);
		...
		JComboBox<String> funSexo_comboBox = new JComboBox <> (new String [] {"Masculino", "Feminino", "Outro"});
		...
		JComboBox<String> funEstadoCivil_comboBox = new JComboBox <> (new String [] {"Solteiro(a)", "Casado(a)", "Divorciado(a)", "Viúvo(a)"});
		...
		JComboBox<String> funStatusF_comboBox = new JComboBox <> (new String [] {"Ativo", "Invativo"});
		...
		funCadastrar_Button.addActionListener(new ActionListener () {
			...
			public void actionPerformed(ActionEvent e) {
		            ...
		            ControladorControleAcesso controladorControleAcesso = new ControladorControleAcesso();

		            if (controladorControleAcesso.validarSenhas(senha, confirmacaoSenha)) {
		...
		JComboBox<String> funEstado_comboBox = new JComboBox <> (new String [] {"AC", "AL", "AP", "AM", "BA", "CE", "DF", "ES", "GO", "MA", "MT", "MS", "MG", "PA", "PB", "PE", "PI", "PR", "RJ", "RN", "RS", "RR", "RO", "SC", "SP", "SE", "TO"});
		...
		JComboBox<String> funFuncao_comboBox = new JComboBox <> (new String [] {"Gerente", "Funcionário"});
	...
	private void cadastrarFuncionario() {
        ...
        controladorControleAcesso.cadastrarFuncionario(nome, cpf, rg, orgExp, telefone, email, dataNascimento, dataExp, cnh, validadeCNH,
