        ...
        botaoCadastrar.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
        		try {
            		...
            		String numeroTexto = campoTextoNumero.getText();
            		...
            		controlador.registrarCliente(nomeCompleto,dataNascimento, cpf, sexo, cnh, vencimentoCnh, bairroRua, numeroTexto, cep, cidade, estado, telefone, email);
