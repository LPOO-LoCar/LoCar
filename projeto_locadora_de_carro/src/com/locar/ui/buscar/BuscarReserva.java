...
public class BuscarReserva extends JFrame {
    ...
    private void buscarTodasReservas() {
        ...
        List<Reserva> reservas = repositorio.buscarTodasReservas();
    ...
    private void buscarReservaPorCpf() {
        ...
        Repositorio repositorio = new Repositorio();
        List<Reserva> reservas = repositorio.buscarReservaPorCpf(cpf);
    ...
    private void buscarReservaPorPlaca() {
        ...
        Repositorio repositorio = new Repositorio();
        List<Reserva> reservas = repositorio.buscarReservaPorPlaca(placa);
