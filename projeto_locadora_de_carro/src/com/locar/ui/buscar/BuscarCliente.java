...
public class BuscarCliente extends JFrame {
    ...
    private void buscarClientePorCpf() {
        String cpf = locCPF_textField.getText().trim();
        ClienteRepositorio clienteRepositorio = new ClienteRepositorio();
        List<Cliente> clientes = clienteRepositorio.buscarClientesPorCpf(cpf);
    ...
    private void buscarClientePorNomeCompleto() {
        String nomeCompleto = locNome_textField.getText().trim(); 

        ClienteRepositorio clienteRepositorio = new ClienteRepositorio();
        List<Cliente> clientes = clienteRepositorio.buscarClientesPorNomeCompleto(nomeCompleto); 
