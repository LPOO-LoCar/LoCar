...
public class RelatoriosFinanceiros {
    ...
    private void initialize() {
        ...
        dataset.addValue(repositorio.calcularReceitaTotal(), "Total Receitas", "Total Receitas");
        ...
        renderer.setDefaultItemLabelGenerator(new StandardCategoryItemLabelGenerator("{2}", NumberFormat.getCurrencyInstance()));
        ...
        btnMensal.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                atualizarGrafico("Receita Mensal", repositorio.calcularReceitaMesAtual());
            }
        });
        ...
        btnTrimestral.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                atualizarGrafico("Receita Semestral", repositorio.calcularReceitaSemestreAtual());
            }
        });
        ...
        btnAnual.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                atualizarGrafico("Receita Anual", repositorio.calcularReceitaAnoAtual());
            }
        });
        ...
        btnValorTotal.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                atualizarGrafico("Total Receitas", repositorio.calcularReceitaTotal());
            }
        });
