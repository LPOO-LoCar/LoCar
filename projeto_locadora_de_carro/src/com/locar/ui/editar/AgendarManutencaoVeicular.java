...
public class AgendarManutencaoVeicular extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			...
			public void run() {
				try {
					AgendarManutencaoVeicular frame = new AgendarManutencaoVeicular("ADMIN");
	 ...
	 * Create the frame.
	 */
	public AgendarManutencaoVeicular(String funcao) {
    ...
    private void buscarTodosAgendamentoManuntencao() {
        ...
        List<AgendamentoManutencao> agendamentosManuntencao = agendamentoManuntencaoRepositorio.buscarTodosAgendamentosManutencao();

        modelo.setRowCount(0);
        for (AgendamentoManutencao agendamentoManuntencao : agendamentosManuntencao) {
