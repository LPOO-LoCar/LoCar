...
public class EditarLocacao extends JFrame {
	...
	public EditarLocacao(String funcao) {
		...
		JComboBox<String> locFormaDePag_comboBox = new JComboBox <> (new String [] {"Dinheiro", "Pix", "Cartão-Debito", "Cartão-Credito",});
		...
		JComboBox<String> campoTextoStatus = new JComboBox<>();
		...
		locPlaca_textField.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
		        ...
		        Locacao locacao = locacaoRepositorio.buscarDadosLocacao(cpf, placa);
		...
		locValorDaDiaria_textField.addFocusListener(new FocusAdapter() {
			@Override
		...
		locDiasLocados_textField.addFocusListener(new FocusAdapter() {
			@Override
			public void focusLost(FocusEvent e) {
			}
		});
		...
		locValorTotal_textField.addFocusListener(new FocusAdapter() {
			@Override
		...
		locLocar_Button_1.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
        		...
        		String placa = locPlaca_textField.getText();
        		LocacaoRepositorio locacaoRepositorio = new LocacaoRepositorio();
        		locacaoRepositorio.excluirLocacao(cpf, placa);
	...
	private void calcularValorTotal() {
	    try {
	        String diariaText = locValorDaDiaria_textField.getText();
	        String diasText = locDiasLocados_textField.getText();

	        if (diariaText == null || diariaText.trim().isEmpty() || diasText == null || diasText.trim().isEmpty()) {
	            locValorTotal_textField.setText("");  
	            return;
	        }

	        double valorDiaria = Double.parseDouble(diariaText);
	        int diasLocados = Integer.parseInt(diasText);
