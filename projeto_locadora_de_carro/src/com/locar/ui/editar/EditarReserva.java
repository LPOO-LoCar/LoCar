...
public class EditarReserva extends JFrame {
	...
	public EditarReserva(String funcao) {
		...
		JLabel resTitulo_Label = new JLabel("Gerenciamento de reservas");
		resTitulo_Label.setFont(new Font("Tahoma", Font.PLAIN, 35));
		resTitulo_Label.setBounds(111, 9, 431, 37);
		...
		JComboBox<String> locTipo_comboBox = new JComboBox <> (new String [] {"Hatch", "Sedan", "SUV", "Picape", "Minivan", "Outro"});
		...
		locPlaca_textField.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
		        ...
		        ReservaRepositorio reservaRepertorio = new ReservaRepositorio();
		        ...
		        Reserva reserva = reservaRepertorio.buscarDadosReserva(cpf, placa);

		        resDatadeRetirada_textField.setText(reserva.getDataRetirada());
		        resHoradeRetirada_textField.setText(reserva.getHoraRetirada());
		        resDatadeEntrega_textField.setText(reserva.getDataRetirada());
		        resHoradeEntrega_textField.setText(reserva.getHoraEntrega());
		...
		reservar_Button.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
		        try {
		            ...
		            controlador.editarReserva(cliente, carro, dataRetirada, horaRetirada, dataEntrega, horaEntrega);
		...
		reservar_Button.setBounds(516, 508, 108, 35);
		...
		btnNewButton_1_1.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
        		...
        		reservaRepositorio.excluirReserva(cpf, placa);

        		JOptionPane.showMessageDialog(null, "Reserva excluída com sucesso!", "Sucesso", JOptionPane.INFORMATION_MESSAGE);
    		} catch (Exception e3) {
		...
		btnNewButton_1_1.setBounds(403, 509, 100, 35);
