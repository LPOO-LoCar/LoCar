	...
	public EditarFuncionario(String funcao) {
		...
		funCPF_textField.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				FuncionarioRepositorio FuncionairoRepositorio = new FuncionarioRepositorio();
				Funcionario funcionario = FuncionairoRepositorio.buscarDadosFuncionario(cpf);
		...
		funCadastrar_Button.addActionListener(new ActionListener () {
			...
			public void actionPerformed(ActionEvent e) {
				...
				JOptionPane.showMessageDialog(null, "Funcionario editado com sucesso!", "Sucesso", JOptionPane.INFORMATION_MESSAGE);
                    ...
                    JOptionPane.showMessageDialog(null, "Erro ao editar o Funcionario. Tente novamente.", "Erro", JOptionPane.ERROR_MESSAGE);
                }
			}
		});
		...
		funCadastrar_Button_1.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
        		try {
        		String cpf = funCPF_textField.getText();
        		FuncionarioRepositorio funcioanrioRepositorio = new FuncionarioRepositorio();
        		funcioanrioRepositorio.excluirFuncionario(cpf);
